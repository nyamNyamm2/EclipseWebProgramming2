		...
		<div id="section_wrap">
			...
			<div class="modify_account_form">
				...
				<form action="<c:url value='/user/member/modifyAccountConfirm' />" name="modify_account_form" method="post">
					...
					<input type="text" name="u_m_name" value="${loginedUserMemberVo.u_m_name}" placeholder="사용자 이름 입력"> <br>
					...
					<input type="email"	name="u_m_mail" value="${loginedUserMemberVo.u_m_mail}" placeholder="사용자 메일 입력" ><br>
					<input type="text" name="u_m_phone"	value="${loginedUserMemberVo.u_m_phone}" placeholder="사용자 전화번호 입력"> <br>
					<input type="button" value="수정하기" onclick="modifyAccountForm();"> 
