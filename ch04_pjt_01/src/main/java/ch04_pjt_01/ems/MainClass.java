...
//                new GenericXmlApplicationContext(appCtxs);
		...
		System.out.println("\n------------ 학생 정보 -----------");
		System.out.print("학번:" + selectedstudent.getsNum() + "\t");
		System.out.print("|ID:" + selectedstudent.getsId() + "\t");
		System.out.print("|비밀번호:" + selectedstudent.getsPw() + "\t");
		System.out.print("|이름:" + selectedstudent.getsName() + "\t");
		System.out.print("|나이:" + selectedstudent.getsAge() + "\t");
		System.out.print("|성별:" + selectedstudent.getsGender() + "\t");
		System.out.println("|전공:" + selectedstudent.getsMajor());
		System.out.println("--------------------------------");

		// 학생 수정
		StudentModifyService modifyService = ctx.getBean("studentModifyService", StudentModifyService.class);
		modifyService.modify(new Student("hbs006", "pigggg", "p0066", "melissa", 27, 'w', "Computer"));
